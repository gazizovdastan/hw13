    ...
    static var settings: [[Setting]] = [
        [
            ...
            Setting(label: "Bluetooth", type: .withDetail,
                 icon: UIImage(named: "blu"), detailText: "Вкл.", iconBackgroundColor: .systemBlue),
            ...
            Setting(label: "VPN", type: .withSwitch, icon: UIImage(systemName: "network.badge.shield.half.filled"), iconBackgroundColor: .systemBlue)
        ],
        [
